...
export const FORMAT_DOC1 = 'data-liveEditor-formatDoc1'
export const FORMAT_DOC2 = 'data-liveEditor-formatDoc2'
export const FORMAT_DOC_LINK = 'data-liveEditor-formatDocLink'
export const SWITCH_MODE = 'liveEditor-switchMode'
export const SUBMIT = 'liveEditor-submitBotton'

export const htmlSourceOfTools = `
	<aside id="htmlEditorToolsContainer">
		<form>
			  <div id="toolbar1">
					<select ${FORMAT_DOC1}="formatblock">
			  ...
			  <div id="toolbar2">
					...
					<img class="intLink" title="Undo" ${FORMAT_DOC2}="undo"
					...
					<img class="intLink" title="Redo" ${FORMAT_DOC2}="redo"
					...
					<img class="intLink" title="Remove formatting" ${FORMAT_DOC2}="removeFormat"
					...
					<img class="intLink" title="Bold" ${FORMAT_DOC2}="bold"
					...
					<img class="intLink" title="Italic" ${FORMAT_DOC2}="italic"
					...
					<img class="intLink" title="Underline" ${FORMAT_DOC2}="underline"
					...
					<img class="intLink" title="Left align" ${FORMAT_DOC2}="justifyleft"
					...
					<img class="intLink" title="Center align" ${FORMAT_DOC2}="justifycenter"
					...
					<img class="intLink" title="Right align" ${FORMAT_DOC2}="justifyright"
					...
					<img class="intLink" title="Numbered list" ${FORMAT_DOC2}="insertorderedlist"
					...
					<img class="intLink" title="Dotted list" ${FORMAT_DOC2}="insertunorderedlist"
					...
					<img class="intLink" title="Quote" ${FORMAT_DOC2}="formatblock,blockquote"
					...
					<img class="intLink" title="Delete indentation" ${FORMAT_DOC2}="outdent"
					...
					<img class="intLink" title="Add indentation" ${FORMAT_DOC2}="indent"
					...
					<img class="intLink" title="Hyperlink" id="${FORMAT_DOC_LINK}"
					...
					<img class="intLink" title="Cut" ${FORMAT_DOC2}="cut"
					...
					<img class="intLink" title="Copy" ${FORMAT_DOC2}="copy"
					...
					<img class="intLink" title="Paste" ${FORMAT_DOC2}="paste"
			  ...
			  <input style="cursor: pointer" type="checkbox" id="${SWITCH_MODE}" />
			  <label style="cursor: pointer" for="${SWITCH_MODE}">Show HTML</label>
	
			  <input type="button" value="Save" style="cursor:pointer" id="${SUBMIT}" />
		</form>
	</aside>`

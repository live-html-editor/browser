...
export const htmlSourceOfTools = `
	<aside id="htmlEditorToolsContainer">
		<form>
			  <div id="toolBar1">
					<select onchange="liveHtmlEditor.editorManager.formatDoc('formatblock',this[this.selectedIndex].value);window.getSelection().focusNode.parentNode.setAttribute('dir', 'auto');this.selectedIndex=0;">
					...
					<select onchange="liveHtmlEditor.editorManager.formatDoc('fontname',this[this.selectedIndex].value);this.selectedIndex=0;">
					...
					<select onchange="liveHtmlEditor.editorManager.formatDoc('fontsize',this[this.selectedIndex].value);this.selectedIndex=0;">
					...
					<select onchange="liveHtmlEditor.editorManager.formatDoc('forecolor',this[this.selectedIndex].value);this.selectedIndex=0;">
					...
					<select onchange="liveHtmlEditor.editorManager.formatDoc('backcolor',this[this.selectedIndex].value);this.selectedIndex=0;">
			  ...
			  <div id="toolBar2">
					...
					<img class="intLink" title="Undo" onclick="liveHtmlEditor.editorManager.formatDoc('undo');"
					...
					<img class="intLink" title="Redo" onclick="liveHtmlEditor.editorManager.formatDoc('redo');"
					...
					<img class="intLink" title="Remove formatting" onclick="liveHtmlEditor.editorManager.formatDoc('removeFormat')"
					...
					<img class="intLink" title="Bold" onclick="liveHtmlEditor.editorManager.formatDoc('bold');"
					...
					<img class="intLink" title="Italic" onclick="liveHtmlEditor.editorManager.formatDoc('italic');"
					...
					<img class="intLink" title="Underline" onclick="liveHtmlEditor.editorManager.formatDoc('underline');"
					...
					<img class="intLink" title="Left align" onclick="liveHtmlEditor.editorManager.formatDoc('justifyleft');"
					...
					<img class="intLink" title="Center align" onclick="liveHtmlEditor.editorManager.formatDoc('justifycenter');"
					...
					<img class="intLink" title="Right align" onclick="liveHtmlEditor.editorManager.formatDoc('justifyright');"
					...
					<img class="intLink" title="Numbered list" onclick="liveHtmlEditor.editorManager.formatDoc('insertorderedlist');"
					...
					<img class="intLink" title="Dotted list" onclick="liveHtmlEditor.editorManager.formatDoc('insertunorderedlist');"
					...
					<img class="intLink" title="Quote" onclick="liveHtmlEditor.editorManager.formatDoc('formatblock','blockquote');"
					...
					<img class="intLink" title="Delete indentation" onclick="liveHtmlEditor.editorManager.formatDoc('outdent');"
					...
					<img class="intLink" title="Add indentation" onclick="liveHtmlEditor.editorManager.formatDoc('indent');"
					...
					<img class="intLink" title="Hyperlink"
						  onclick="var sLnk=prompt('Write the URL here','http:\\/\\/');if(sLnk&&sLnk!=''&&sLnk!='http://'){liveHtmlEditor.editorManager.formatDoc('createlink',sLnk)}"
					...
					<img class="intLink" title="Cut" onclick="liveHtmlEditor.editorManager.formatDoc('cut');"
					...
					<img class="intLink" title="Copy" onclick="liveHtmlEditor.editorManager.formatDoc('copy');"
					...
					<img class="intLink" title="Paste" onclick="liveHtmlEditor.editorManager.formatDoc('paste');"
			  ...
			  <input style="cursor: pointer" type="checkbox" name="switchMode" id="switchMode" onchange="this.checked? liveHtmlEditor.editorManager.setSourceMode() : liveHtmlEditor.editorManager.setDocMode();"/>
			  <label style="cursor: pointer" for="switchMode">Show HTML</label>
	
			  <input type="button" value="Save" style="cursor:pointer" onclick="liveHtmlEditor.editorManager.submit(liveHtmlEditor.editorManager.editors[0])"/>
		</form>
	</aside>`;
